...
def on_send():
    ...
    with st.spinner("Dracula is thinking..."):
        try:
    ...
    st.session_state.history.append({"user": query, "dracula": reply})
    ...
    with right_col:
        ...
        if st.session_state.history:
            for chat in reversed(st.session_state.history):
                ...
                st.markdown(f"**🧛 Dracula:** {chat['dracula']}")
                st.markdown("---")
        else:
